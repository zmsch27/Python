#以下来自廖雪峰的Python学习之Python电子邮件

#现在我们回到电子邮件，假设我们自己的电子邮件地址是me@163.com，对方的电子邮件地址是friend@sina.com
#现在我们写好邮件，填上对方的Email地址，点“发送”，电子邮件就发出去了。这些电子邮件软件被称为MUA：Mail User Agent——邮件用户代理。
...
#因为它只服务新浪的用户，所以，你得填163提供的SMTP服务器地址：smtp.163.com
...
import smtplib
# 输入Email地址和口令:
from_addr = 'zmsch27@sina.com'
password = 'zimushuch27'
# 输入收件人地址:
to_addr = '1319628095@qq.com'
# 输入SMTP服务器地址:
...
#发送HTML邮件----------------------------------------------
#如果我们要发送HTML邮件，方法很简单，在构造MIMEText对象时，把HTML字符串传进去，再把第二个参数由plain变为html就可以了：
